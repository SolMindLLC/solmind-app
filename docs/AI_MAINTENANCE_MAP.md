...
- S03 genuine provider conversation beyond the banked provider-free S03A
  kernel and provider-neutral S03B dispatch contract: source repositories,
  current authorization/consent revalidation, snapshot and audit/fingerprint
  enforcement, context budgeting, a concrete provider adapter and credentials,
  provider selection, session/message persistence, safety response, and UI.
