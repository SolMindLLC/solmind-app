...
- S03 genuine provider conversation beyond the banked provider-free S03A
  kernel, provider-neutral S03B dispatch contract and source-injected S03C
  authorization composer: concrete source repositories, persisted snapshot plus
  pre-I/O audit/fingerprint enforcement, context budgeting, a concrete provider
  adapter and credentials, provider selection, session/message persistence,
  safety response, and UI.
